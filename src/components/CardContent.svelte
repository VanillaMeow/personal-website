...
<div
    bind:this={cardEl}
    class="glass-card w-full p-4 sm:p-6 md:p-8 relative overflow-hidden {vt.activeTab.maxWidth}"
...
>
    ...
    >
        <RainSlider />
        <TabNav view={vt.view} onchange={(v) => vt.switchView(v, cardEl)} />
    </div>

    <div
        class="view-container"
        class:animate={vt.ready}
        class:scrollable={vt.overflowing}
